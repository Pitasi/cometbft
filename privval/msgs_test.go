...
import (
	...
	privproto "github.com/cometbft/cometbft/proto/cometbft/privval/v2"
	privproto1 "github.com/cometbft/cometbft/proto/cometbft/privval/v1"
...
func TestPrivvalVectors(t *testing.T) {
	...
	remoteError := &privproto1.RemoteSignerError{Code: 1, Description: "it's a error"}
	...
	testCases := []struct {
		...
		{"ping request", &privproto1.PingRequest{}, "3a00"},
		{"ping response", &privproto1.PingResponse{}, "4200"},
		{"pubKey request", &privproto1.PubKeyRequest{}, "0a00"},
		{"pubKey response", &privproto1.PubKeyResponse{PubKey: ppk, Error: nil}, "12240a220a20556a436f1218d30942efe798420f51dc9b6a311b929c578257457d05c5fcf230"},
		{"pubKey response with error", &privproto1.PubKeyResponse{PubKey: cryptoproto.PublicKey{}, Error: remoteError}, "12140a0012100801120c697427732061206572726f72"},
		...
		{"Proposal Request", &privproto1.SignProposalRequest{Proposal: proposalpb}, "2a700a6e08011003180220022a4a0a208b01023386c371778ecb6368573e539afc3cc860ec3a2f614e54fe5652f4fc80122608c0843d122072db3d959635dff1bb567bedaa70573392c5159666a3f8caf11e413aac52207a320608f49a8ded053a10697427732061207369676e6174757265"},
		{"Proposal Response", &privproto1.SignedProposalResponse{Proposal: *proposalpb, Error: nil}, "32700a6e08011003180220022a4a0a208b01023386c371778ecb6368573e539afc3cc860ec3a2f614e54fe5652f4fc80122608c0843d122072db3d959635dff1bb567bedaa70573392c5159666a3f8caf11e413aac52207a320608f49a8ded053a10697427732061207369676e6174757265"},
		{"Proposal Response with error", &privproto1.SignedProposalResponse{Proposal: cmtproto1.Proposal{}, Error: remoteError}, "32250a112a021200320b088092b8c398feffffff0112100801120c697427732061206572726f72"},
	}
