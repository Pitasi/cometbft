...
// source: cometbft/rpc/grpc/v1/types.proto
...
func (*RequestPing) Descriptor() ([]byte, []int) {
	return fileDescriptor_6114f5416578425e, []int{0}
}
...
func (*RequestBroadcastTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_6114f5416578425e, []int{1}
}
...
func (*ResponsePing) Descriptor() ([]byte, []int) {
	return fileDescriptor_6114f5416578425e, []int{2}
}
...
type ResponseBroadcastTx struct {
	CheckTx   *v1.ResponseCheckTx   `protobuf:"bytes,1,opt,name=check_tx,json=checkTx,proto3" json:"check_tx,omitempty"`
	DeliverTx *v1.ResponseDeliverTx `protobuf:"bytes,2,opt,name=deliver_tx,json=deliverTx,proto3" json:"deliver_tx,omitempty"`
}
...
func (*ResponseBroadcastTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_6114f5416578425e, []int{3}
}
...
func (m *ResponseBroadcastTx) GetCheckTx() *v1.ResponseCheckTx {
	if m != nil {
		return m.CheckTx
	}
	return nil
...
func (m *ResponseBroadcastTx) GetDeliverTx() *v1.ResponseDeliverTx {
	if m != nil {
		return m.DeliverTx
	}
	return nil
...
func init() {
	proto.RegisterType((*RequestPing)(nil), "cometbft.rpc.grpc.v1.RequestPing")
	proto.RegisterType((*RequestBroadcastTx)(nil), "cometbft.rpc.grpc.v1.RequestBroadcastTx")
	proto.RegisterType((*ResponsePing)(nil), "cometbft.rpc.grpc.v1.ResponsePing")
	proto.RegisterType((*ResponseBroadcastTx)(nil), "cometbft.rpc.grpc.v1.ResponseBroadcastTx")
}

func init() { proto.RegisterFile("cometbft/rpc/grpc/v1/types.proto", fileDescriptor_6114f5416578425e) }

var fileDescriptor_6114f5416578425e = []byte{
	// 314 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x48, 0xce, 0xcf, 0x4d,
	0x2d, 0x49, 0x4a, 0x2b, 0xd1, 0x2f, 0x2a, 0x48, 0xd6, 0x4f, 0x07, 0x11, 0x65, 0x86, 0xfa, 0x25,
	0x95, 0x05, 0xa9, 0xc5, 0x7a, 0x05, 0x45, 0xf9, 0x25, 0xf9, 0x42, 0x22, 0x30, 0x15, 0x7a, 0x45,
	0x05, 0xc9, 0x7a, 0x20, 0x15, 0x7a, 0x65, 0x86, 0x52, 0x32, 0x70, 0x7d, 0x89, 0x49, 0xc9, 0x99,
	0x68, 0x7a, 0x94, 0x78, 0xb9, 0xb8, 0x83, 0x52, 0x0b, 0x4b, 0x53, 0x8b, 0x4b, 0x02, 0x32, 0xf3,
	...
	,
}
...
func (c *broadcastAPIClient) Ping(ctx context.Context, in *RequestPing, opts ...grpc.CallOption) (*ResponsePing, error) {
	...
	err := c.cc.Invoke(ctx, "/cometbft.rpc.grpc.v1.BroadcastAPI/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastAPIClient) BroadcastTx(ctx context.Context, in *RequestBroadcastTx, opts ...grpc.CallOption) (*ResponseBroadcastTx, error) {
	...
	err := c.cc.Invoke(ctx, "/cometbft.rpc.grpc.v1.BroadcastAPI/BroadcastTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BroadcastAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cometbft.rpc.grpc.v1.BroadcastAPI/Ping",
	}
...
func _BroadcastAPI_BroadcastTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cometbft.rpc.grpc.v1.BroadcastAPI/BroadcastTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _BroadcastAPI_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cometbft.rpc.grpc.v1.BroadcastAPI",
	...
	Metadata: "cometbft/rpc/grpc/v1/types.proto",
}
...
func (m *ResponseBroadcastTx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.DeliverTx == nil {
				m.DeliverTx = &v1.ResponseDeliverTx{}
			}
