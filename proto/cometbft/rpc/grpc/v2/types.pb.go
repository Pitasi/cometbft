...
// source: cometbft/rpc/grpc/v2/types.proto
...
import (
	...
	v1 "github.com/cometbft/cometbft/rpc/grpc/v1"
...
type ResponseBroadcastTx struct {
	CheckTx   *v2.ResponseCheckTx   `protobuf:"bytes,1,opt,name=check_tx,json=checkTx,proto3" json:"check_tx,omitempty"`
	DeliverTx *v2.ResponseDeliverTx `protobuf:"bytes,2,opt,name=deliver_tx,json=deliverTx,proto3" json:"deliver_tx,omitempty"`
}
...
func (*ResponseBroadcastTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_c678eb337633f265, []int{0}
}
...
func (m *ResponseBroadcastTx) GetCheckTx() *v2.ResponseCheckTx {
	if m != nil {
		return m.CheckTx
	}
	return nil
...
func (m *ResponseBroadcastTx) GetDeliverTx() *v2.ResponseDeliverTx {
	if m != nil {
		return m.DeliverTx
	}
	return nil
...
func init() {
	proto.RegisterType((*ResponseBroadcastTx)(nil), "cometbft.rpc.grpc.v2.ResponseBroadcastTx")
}

func init() { proto.RegisterFile("cometbft/rpc/grpc/v2/types.proto", fileDescriptor_c678eb337633f265) }

var fileDescriptor_c678eb337633f265 = []byte{
	// 293 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x48, 0xce, 0xcf, 0x4d,
	0x2d, 0x49, 0x4a, 0x2b, 0xd1, 0x2f, 0x2a, 0x48, 0xd6, 0x4f, 0x07, 0x11, 0x65, 0x46, 0xfa, 0x25,
	0x95, 0x05, 0xa9, 0xc5, 0x7a, 0x05, 0x45, 0xf9, 0x25, 0xf9, 0x42, 0x22, 0x30, 0x15, 0x7a, 0x45,
	0x05, 0xc9, 0x7a, 0x20, 0x15, 0x7a, 0x65, 0x46, 0x52, 0xd8, 0xf4, 0x19, 0x22, 0xeb, 0x93, 0x92,
	0x81, 0xab, 0x48, 0x4c, 0x4a, 0xce, 0x44, 0x33, 0x55, 0x69, 0x3a, 0x23, 0x97, 0x70, 0x50, 0x6a,
	...
	,
}
...
func (c *broadcastAPIClient) Ping(ctx context.Context, in *v1.RequestPing, opts ...grpc.CallOption) (*v1.ResponsePing, error) {
	...
	err := c.cc.Invoke(ctx, "/cometbft.rpc.grpc.v2.BroadcastAPI/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastAPIClient) BroadcastTx(ctx context.Context, in *v1.RequestBroadcastTx, opts ...grpc.CallOption) (*ResponseBroadcastTx, error) {
	...
	err := c.cc.Invoke(ctx, "/cometbft.rpc.grpc.v2.BroadcastAPI/BroadcastTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BroadcastAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cometbft.rpc.grpc.v2.BroadcastAPI/Ping",
	}
...
func _BroadcastAPI_BroadcastTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cometbft.rpc.grpc.v2.BroadcastAPI/BroadcastTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _BroadcastAPI_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cometbft.rpc.grpc.v2.BroadcastAPI",
	...
	Metadata: "cometbft/rpc/grpc/v2/types.proto",
}
...
func (m *ResponseBroadcastTx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.DeliverTx == nil {
				m.DeliverTx = &v2.ResponseDeliverTx{}
			}
